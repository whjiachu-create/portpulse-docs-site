...
2. Enter: `https://api.useportpulse.com/v1/openapi.json`
3. Click **Import**
...
1. Download the OpenAPI spec:
   ```bash
   curl -o portpulse-openapi.json https://api.useportpulse.com/v1/openapi.json
   ```
2. In Insomnia: **Create** → **Import from File**
...
```json
{
  "baseUrl": "https://api.useportpulse.com/v1",
  "apiKey": "dev_demo_123"
}
```
...
### 2. Port Overview
```http
GET &#123;&#123; _.baseUrl &#125;&#125;/ports/USLAX/overview
X-API-Key: &#123;&#123; _.apiKey &#125;&#125;
```
...
### Request CSV Format
```http
GET &#123;&#123; _.baseUrl &#125;&#125;/ports/USLAX/trend?window=30d&format=csv
X-API-Key: &#123;&#123; _.apiKey &#125;&#125;
```
...
### Port Trends (JSON)
```http
GET &#123;&#123; _.baseUrl &#125;&#125;/ports/USLAX/trend?window=30d&format=json
X-API-Key: &#123;&#123; _.apiKey &#125;&#125;
```

### Port Alerts
```http
GET &#123;&#123; _.baseUrl &#125;&#125;/ports/USLAX/alerts
X-API-Key: &#123;&#123; _.apiKey &#125;&#125;
```
